        ...
        <TouchableWithoutFeedback onPress={closeAllDropdowns}>
          <View style={styles.modalView}>
            <View style={styles.modalCard}>
              ...
              {/* Qualification */}
              <View style={[styles.inputContainer, { zIndex: 20000}]}>
                <TextInput
              ...
              {/* Specialization */}
              <View style={[styles.inputContainer, { zIndex: 10001, position: "relative" }]}>
                <TextInput
              ...
              {/* Skills */}
              <View style={[styles.inputContainer, { zIndex: 10000}]}>
                <TextInput
...
const styles = StyleSheet.create({
  ...
  dropdown: {
    ...
    elevation: 10, // Added elevation for better visibility
  },
  suggestionItem: {
    padding: 10,
    fontSize: 16,
